...
const listUsers = async function(req, res) {
  ...
  await db('Users')
    ...
    .join('User_has_Companies', 'User_has_Companies.User_pk_uuid', '=', 'Users.pk_uuid')
    .join('User_has_Companies', 'Companies.uuid_company', '=', 'User_has_Companies.Companies_uuid_company')
    .where()
    .then(data => {
      return res.render('index', 
      { 
