...
const newRoom = function(req, res) {
  res.render('index', { title:  'New room | SyncReady', page: 'dashboard', subPage: 'list_room'})
}

const listRoom = function(req, res) {
  res.render('index', { title:  'List of rooms | SyncReady', page: 'dashboard', subPage: 'room_new_form'})
}
