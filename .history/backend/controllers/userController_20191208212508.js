...
const getUserType = async function(companyCode, isAdmin) {
...
const saveUser = async function(req) {
  const { fullname, address, email, contacto, cc, username, password, companyCode, type } = req.body
  await getUserType(type)
