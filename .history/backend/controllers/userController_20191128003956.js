...
const login = function(email, password, res) {
  ...
  const error.errorOnInsert = { message: 'Ocorreu um erro ao realizar o seu pedido - tente mais tarde :(' }

  res.render('index', { title: 'SyncReady', page: 'main/login', error , predata: { } } )
...
const register = async function(req, res) {
  ...
  if (Object.keys(errors).length > 0) {
    ...
    .catch(_ => {
      errors.errorOnInsert = { message: 'Ocorreu um erro ao realizar o seu pedido - tente mais tarde :(' }
