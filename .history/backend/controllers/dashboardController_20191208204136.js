...
const listRoom = async function(req, res) {
  ...
  await db('Users')
    .select('pk_uuid')
    .innerJoin('Users_has_Companies', 'Users_has_Companies.Users.pk_uuid', '=', 'Users.pk_uuid')
    .innerJoin('Companies', 'Users_has_Companies.Companies_uuid_companny', '=', 'Companies.uuid_company')
