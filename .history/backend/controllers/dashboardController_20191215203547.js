...
const registerCompany = function(req, res) {

  const { name, username, companyAddress, companyTelephone, companyCC, companyEmail } = req.body
  ...
  await db('Companies')
    ...
    .then(async _ => {
      // fullname, address, email, contacto, cc, username, password, type, companyCode
