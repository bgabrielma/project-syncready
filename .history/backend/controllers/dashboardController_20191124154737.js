...
const newRoom = function(req, res) {
  res.render('index', { title:  'New room | SyncReady', page: 'dashboard', subPage: 'rooms/list_room'})
}

const listRoom = function(req, res) {
  res.render('index', { title:  'List of rooms | SyncReady', page: 'dashboard', subPage: 'rooms/room_new_form'})
}
