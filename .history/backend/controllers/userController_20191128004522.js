...
const login = function(email, password, res) {
  ...
  res.render('index', { title: 'SyncReady', page: 'main/login', errors: null, messageErrorOnInsert } )
...
const register = async function(req, res) {
  ...
  if (Object.keys(errors).length > 0) {
    ...
    .catch(_ => {
      ...
      res.render('index', { title: 'SyncReady', page: 'main/register', errors , predata: null } )
    })
  }
}
