...
const newAlert = function(req, res) {
  ...
  res.render('index', { title:  'Registar novo alerta | SyncReady', page: 'dashboard', data: {}, subPage: 'alerts/new_alert_form' })
}

const listAlert = function(req, res) {
  res.render('index', { title:  'Lista de alertas | SyncReady', page: 'dashboard', data: {}, subPage: 'alerts/list_alert' })
}
